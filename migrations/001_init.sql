...
CREATE INDEX IF NOT EXISTS idx_tests_filters
    ON tests (year, semester, type, university);

CREATE INDEX IF NOT EXISTS idx_feedback_test_id
    ON feedback (test_id);

CREATE INDEX IF NOT EXISTS idx_feedback_problem_type
    ON feedback (problem_type);

CREATE INDEX IF NOT EXISTS idx_feedback_created_at
    ON feedback (created_at);

CREATE INDEX IF NOT EXISTS idx_feedback_test_rating
    ON feedback (test_id, rating);

CREATE INDEX IF NOT EXISTS idx_export_queue_exported
    ON feedback_export_queue (exported);

CREATE INDEX IF NOT EXISTS idx_export_queue_feedback_id
    ON feedback_export_queue (feedback_id);

CREATE INDEX IF NOT EXISTS idx_test_ratings_avg
    ON test_ratings (avg_rating);
